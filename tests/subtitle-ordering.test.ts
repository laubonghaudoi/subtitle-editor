...
const makeSubtitle = (
  overrides: Partial<import("../types/subtitle").Subtitle>,
) => ({
...
test("sortSubtitlesChronologically normalizes overlapping times", () => {
  const a = makeSubtitle({
    uuid: "a",
    startTime: "00:00:03,000",
    endTime: "00:00:05,000",
    id: 1,
  });
  const b = makeSubtitle({
    uuid: "b",
    startTime: "00:00:04,000",
    endTime: "00:00:06,000",
    id: 2,
  });
  const c = makeSubtitle({
    uuid: "c",
    startTime: "00:00:01,000",
    endTime: "00:00:02,000",
    id: 3,
